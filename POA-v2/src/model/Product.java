...
public class Product implements ICsvConvertible<Product> {
    ...
    public Product(UUID restaurantId, UUID productId,
        ...
        if(ingredients.length > MAX_NUM_INGREDIENTS) {
            System.out.println("A product can have at most 25 ingredients.");
        }
        else {
    ...
    public Product(UUID restaurantId, String name,
                   float price, String[] ingredients) {
    ...
    public String[] stringify() {
        // restaurantId, productId, name, price, ingredients, ingredient1, ..., ingredientn
